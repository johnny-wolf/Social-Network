	          	...
	          	<div class="col-sm-5 col-md-6">
				    ...
				    <c:forEach var="post" items="${posts}">
				    	<div class = "facebook-comment-box">
			            	<div>
			                	<a href="wall?ownerId=${post.poster.id}"><img src="ref-material-prototype/img/${post.poster.picture}" onerror="this.src='ref-material-prototype/img/default.png'" style="width:75px;height:75px;"></a>
			                ...
			                <div>
			                	<p> ${post.formattedDate} | ${post.popularity} Comments</p>
