...
/**
 * Servlet for getting list of friends for right column
 * 
...
public class Friends extends AbstractServlet{
	...
	@Autowired
	public void setFriends(UserManager userManager){
	...
	*/
	protected void processRequest(HttpServletRequest request, HttpServletResponse response)
		...
		if(orderBy != null && orderBy.equals("dateOfBirth")) {
	     ...
	     request.getRequestDispatcher("/friendColumn.jsp").forward(request, response);
	    }
	    ...
	    public String getServletInfo() {
	        return "Servlet for getting list of friends for right column";
	    }
}
